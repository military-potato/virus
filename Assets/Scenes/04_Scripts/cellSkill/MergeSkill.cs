...
public class CombinedCell : EnemyUnit
{
    ...
    public GameObject combinedCellPrefab;
    ...
    protected override void Start()
    {
        ...
        // 방금 base.Start()가 최대 체력으로 되돌려놓은 체력을 원본의 '현재 체력'으로 다시 덮어씀
        if (isClone)
        {
    ...
    private void CloneSelf()
    {
        ...
        if (cloneScript != null)
        {
            // 3. 원본의 '현재 체력(currentHealth)'을 복제본에게 주입
